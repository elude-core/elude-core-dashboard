...
export const QUICK_LINKS: QuickLink[] = [
  ...
  { id: 'status', name: 'Status page', url: 'https://status.elude.fr', iconName: 'BarChart3', description: 'Public status' },
  ...
  { id: 'vercel', name: 'Vercel team', url: 'https://vercel.com/elude-core', iconName: 'Cloud', description: 'Cloud apps' },
  { id: 'github', name: 'GitHub org', url: 'https://github.com/elude-core', iconName: 'Github', description: 'Source code' },
  { id: 'outline', name: 'Outline docs', url: 'https://app.getoutline.com', iconName: 'BookOpen', description: 'Documentation' },
]
