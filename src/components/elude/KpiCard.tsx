  ...
  if (value === null) {
    return (
      <div className="rounded-2xl border border-gray-200 bg-white p-5 dark:border-gray-800 dark:bg-gray-900">
        ...
        <p className="mt-2 text-3xl font-bold text-gray-300 dark:text-gray-700">--</p>
  ...
  return (
    <div className="rounded-2xl border border-gray-200 bg-white p-5 dark:border-gray-800 dark:bg-gray-900">
      ...
      <p className="mt-2 text-3xl font-bold text-gray-900 dark:text-gray-100">
        ...
        {total && <span className="ml-1 text-base font-normal text-gray-500"> / {total.toFixed(0)}{unit ?? ''}</span>}
      </p>
      {pctOfTotal !== null && (
